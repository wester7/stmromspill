...
function planet1_ostus ()
{
    ...
    const planet1musikk = new Blocks.Sound("lyder/musikk/Ostus.m4a",{loop:false,auto:true,volume:0.02});
...
function planet2_tallus ()
{
    ...
    const planet2musikk = new Blocks.Sound("lyder/musikk/Tallus.m4a",{loop:false,auto:true,volume:0.02});
...
function planet3_blubblubia ()
{
    ...
    const planet3musikk = new Blocks.Sound("lyder/musikk/Blub.m4a",{loop:false,auto:true,volume:0.02});
...
function planet4_sylteria ()
{
    ...
    const planet4musikk = new Blocks.Sound("lyder/musikk/Sylteria.m4a",{loop:false,auto:true,volume:0.02});
...
function planet5_rimus ()
{
    ...
    const planet5musikk = new Blocks.Sound("lyder/musikk/Rimus.m4a",{loop:false,auto:true,volume:0.02});
...
function planet6_noffmo ()
{
    ...
    const planet3musikk = new Blocks.Sound("lyder/musikk/Noffmo.m4a",{loop:false,auto:true,volume:0.02});
