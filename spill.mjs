...
function Velkommen() {
    ...
    const radiostemme = new Blocks.Sound("lyder/manuslesing/radiostemme.m4a",{loop:false,auto:false});
    const lydikon = new Blocks.Image("bilder/click/lydikon_liten.png",  {x:400,y:620,width:200,height:150});
    const img1 = new Blocks.Image("bilder/startscene/startscene_startknapp.png", {x:300,y:300,width:400,height:200});
    Actions.Click(img1, () => {
        radiostemme.stop();
        GaaTil(sceneStart);
    })
    Actions.Click(lydikon, () => {
	radiostemme.start();
    })
}
